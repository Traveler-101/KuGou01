import{C as E,a as R,g as k,b,c as D,d as z,e as A,G as Q,A as _,s as h,r as o,f as T,j as r,h as i,i as G,R as I,u as O,L as j,k as B}from"./index.fa75546d.js";const W=e=>({type:z,data:e}),F=e=>({type:A,data:e}),S=e=>({type:E,data:e}),H=e=>({type:Q,data:e}),P=e=>({type:_,data:e}),Y=()=>({type:R}),q=e=>t=>{t(P(e)),k(e).then(s=>{let a=s.data.result.songs;t(F(a)),t(S(!1)),t(H(b()))}).catch(()=>{console.log("\u641C\u7D22\u7ED3\u679C\u51FA\u73B0\u9519\u8BEF")})},M=()=>e=>{D().then(t=>{e(W(t.result.hots)),e(H(b()))}).catch(()=>{console.log("\u70ED\u95E8\u641C\u7D22\u51FA\u9519")})},U=h.div`
    z-index: 99;
    position: absolute;
    width: 100%;
    height: 100%;
