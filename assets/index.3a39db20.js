import{C,a as N,g as E,b as R,c as _,d as k,e as D,G as z,A,s as d,_ as a,f as Q,j as t,h as i,i as T,R as G,u as I,L as O,k as j,l as B}from"./index.98aea6de.js";const W=e=>({type:k,data:e}),F=e=>({type:D,data:e}),b=e=>({type:C,data:e}),P=e=>({type:z,data:e}),Y=e=>({type:A,data:e}),q=()=>({type:N}),M=e=>r=>{r(Y(e)),E(e).then(n=>{let o=n.data.result.songs;r(F(o)),r(b(!1))}).catch(()=>{console.log("\u641C\u7D22\u7ED3\u679C\u51FA\u73B0\u9519\u8BEF")})},U=()=>e=>{R().then(r=>{e(W(r.result.hots)),e(P(_()))}).catch(()=>{console.log("\u70ED\u95E8\u641C\u7D22\u51FA\u9519")})},$=d.div`
    z-index: 99;
    position: absolute;
    width: 100%;
    height: 100%;
